    ...
    if not include_international:
        clauses.append(
            ...
            (
                ...
                OR LOWER(location) LIKE '%remot%'
                OR LOWER(location) LIKE '%home office%'
                OR LOWER(location) LIKE '%teletrabalho%'
                OR LOWER(location) LIKE '% - ac%'
                OR LOWER(location) LIKE '% - al%'
                OR LOWER(location) LIKE '% - am%'
                OR LOWER(location) LIKE '% - ap%'
                OR LOWER(location) LIKE '% - ba%'
                OR LOWER(location) LIKE '% - ce%'
                OR LOWER(location) LIKE '% - df%'
                OR LOWER(location) LIKE '% - es%'
                OR LOWER(location) LIKE '% - go%'
                OR LOWER(location) LIKE '% - ma%'
                OR LOWER(location) LIKE '% - mg%'
                OR LOWER(location) LIKE '% - ms%'
                OR LOWER(location) LIKE '% - mt%'
                OR LOWER(location) LIKE '% - pa%'
                OR LOWER(location) LIKE '% - pb%'
                OR LOWER(location) LIKE '% - pe%'
                OR LOWER(location) LIKE '% - pi%'
                OR LOWER(location) LIKE '% - pr%'
                OR LOWER(location) LIKE '% - rj%'
                OR LOWER(location) LIKE '% - rn%'
                OR LOWER(location) LIKE '% - ro%'
                OR LOWER(location) LIKE '% - rr%'
                OR LOWER(location) LIKE '% - rs%'
                OR LOWER(location) LIKE '% - sc%'
                OR LOWER(location) LIKE '% - se%'
                OR LOWER(location) LIKE '% - sp%'
                OR LOWER(location) LIKE '% - to%'
                OR LOWER(location) LIKE '% - br%'
            )
            """
        )
